...
@class LRCircleMenuView;
@class LRCircleMenuItem;


@protocol LRCircleMenuViewDelegate <NSObject>
...
@interface LRCircleMenuView : UIView

@property (nonatomic, weak) id<LRCircleMenuViewDelegate> delegate;
...
/// 按钮数据
@property (nonatomic, strong) NSArray<LRCircleMenuItem *> *menuItems;
/// 菜单按钮文字颜色,默认`#1E1E1E`
