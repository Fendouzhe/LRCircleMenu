...
@interface LRCircleMenuView ()<UIGestureRecognizerDelegate>
...
@implementation LRCircleMenuView
...
- (void)setMenuItems:(NSArray<LRCircleMenuItem *> *)menuItems {
    ...
    for (NSInteger i=0, count=_menuItems.count; i<count; i++) {
        LRCircleMenuItem *item = _menuItems[i];
        LRCircleMenuButton *button = [LRCircleMenuButton buttonWithType:UIButtonTypeCustom];
        button.tag = i;
